...
export const metadata: Metadata = {
  title: 'Outdoor Gear | M-B Something',
  description:
    'High performance canine gear engineered for durability and style across the British outdoors.',
  keywords: ['outdoor dog gear', 'heavy duty collar', 'tactical leash', 'adventure accessories'],
  alternates: { canonical: 'https://mb-something.co.uk/for-him' },
  openGraph: {
    title: 'Outdoor Gear | M-B Something',
    description:
      'High performance canine gear engineered for durability and style across the British outdoors.',
    images: [{ url: OG_IMAGE, alt: 'M-B Something – Outdoor Gear' }],
  },
};

...
export default function Home() {
  ...
  useEffect(() => {
    if (availableProducts.length > 0 && featuredProducts.length === 0) {
      setFeaturedProducts([...availableProducts].sort(() => 0.5 - Math.random()).slice(0, 4));
    }
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 sm:mb-12 gap-4">
              <div>
                ...
                <h2 className="font-serif-display text-3xl sm:text-4xl font-normal text-neutral-950 tracking-tight">
                  Featured Gear
                </h2>
              </div>
              <Link
                href="/products"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-xs font-semibold uppercase tracking-[0.14em] bg-white border border-neutral-200 text-neutral-950 hover:bg-neutral-50 transition-colors shadow-sm"
              >

      ...
      <div className="bg-white min-h-screen">
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <article className="space-y-10 text-neutral-900 text-sm leading-relaxed">
            ...
            {/* Section 5 - PET SAFETY */}
            <section className="space-y-3" id="pet-safety">
              <h2 className="text-base sm:text-lg font-bold text-neutral-950 tracking-tight uppercase underline underline-offset-4">
                5. Mandatory Pet Gear Safety Notice &amp; Owner Responsibility
              </h2>
            ...
            <section className="space-y-3" id="returns">
              ...
              <div className="space-y-2">
                ...
                <p className="pt-2"><strong>Return Postage:</strong></p>
                <p>
                ...
                <p className="pt-2"><strong>Refund Timeline:</strong></p>
                <p>

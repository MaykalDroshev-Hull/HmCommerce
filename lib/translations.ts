...
const enTranslations: Translations = {
  ...
  emailPendingAfterConfirm: 'After confirmation, you will receive shipping details (weekdays: dispatch today if ordered before 13:00, otherwise the next business day; weekend orders ship Monday).',
